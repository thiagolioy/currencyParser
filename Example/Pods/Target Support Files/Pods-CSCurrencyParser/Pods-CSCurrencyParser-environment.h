...
// CSCurrencyParser
#define COCOAPODS_POD_AVAILABLE_CSCurrencyParser
#define COCOAPODS_VERSION_MAJOR_CSCurrencyParser 0
#define COCOAPODS_VERSION_MINOR_CSCurrencyParser 1
#define COCOAPODS_VERSION_PATCH_CSCurrencyParser 2
